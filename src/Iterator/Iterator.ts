 ...
 * @LastEditTime: 2022-03-11 10:48:51
...
export interface TSTLIterator<T> {
  ...
  next(): T                         // position decrement and return the value
  prev(): T                         // position decrement and return the value
  
  hasNext(): boolean                // test whether has next element
  done(): boolean                   // test has finished the trave (done === !hasNext())
