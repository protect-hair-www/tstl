...
// export const minus = <T>(a: T, b: T): T | Error => {
//     if(typeof a === 'number') return a - b
//     return new Error('unvalid')
// }

// export const multiplies = <T>(a: T, b: T): T | Error => {
//     if(typeof a === 'number') return a * b
//     return new Error('unvalid')
// }

// export const divides = <T>(a: T, b: T): T | Error => {
//     if(typeof a === 'number') return a / b
//     return new Error('unvalid')
// }

// export const modulus = <T>(a: T, b: T): T | Error => {
//     if(typeof a === 'number') return a % b
//     return new Error('unvalid')
// }

// export const negation = <T>(a: T): T | Error => {
